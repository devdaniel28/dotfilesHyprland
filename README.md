...
Bash
```shell
 sudo pacman -S hyprland hypridle hyprlock hyprpaper kitty wofi waybar cava wlogout swaync waypaper 

 # Ou use

 yay -S hyprland hypridle hyprlock hyprpaper kitty wofi waybar cava wlogout swaync waypaper 
```
